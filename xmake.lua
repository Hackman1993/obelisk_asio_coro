...
add_requires("sahara", "spdlog", "openssl", "nlohmann_json")
...
target("obelisk")
    ...
    add_packages("sahara", "boost", "spdlog", "openssl", "nlohmann_json")
...
target("obelisk_test")
    ...
    add_packages("boost", "sahara", "spdlog", "openssl", "nlohmann_json")