...
obelisk::task<std::unique_ptr<obelisk::http::http_response>> member_controller::view(obelisk::http::http_request_wrapper&request) {
    std::vector<validator_group> validators;
    validators.emplace_back(validator_group{"page", {integer()}});
