...
namespace module::default_::migrations
{
    ...
    class insert_permissions_data final : public migration::base_migration{
        ...
        boost::asio::awaitable<void> up() override
        {
            ...
            co_await utils::register_permission("permission.sys_admin.enable", true);
            co_await utils::register_permission("permission.sys_admin.assign_roles", true);
            ...
            co_await utils::register_permission("permission.sys_role.assign_permissions", true);
